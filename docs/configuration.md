...
|batchTimeout|No|The time after which a message batch is flushed if it is not yet full and when additional messages are requested. The default is 50ms. An application can override this by adding the application name as a prefix.|
