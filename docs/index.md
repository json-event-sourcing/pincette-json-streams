...
The languages you need to work with it are the [MongoDB Operator](https://docs.mongodb.
com/manual/reference/operator/query/) language, [JQ](https://github.com/eiiches/jackson-jq) (preferred) or 
